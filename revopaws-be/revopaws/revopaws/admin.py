...
from apps.marketplace.models import Order, Product
from apps.revoshop.models import ProductCategory
from apps.payments.models import PaymentOption, SwapRecord
from apps.trash.models import Trash, TrashRecord
from apps.users.models import CustomUser

class CustomAdminSite(admin.AdminSite):
    site_header = "Revopaws Admin Panel"
    site_title = "Revopaws"
    index_title = "Selamat Datang di Revopaws Admin"
...
admin_site = CustomAdminSite(name='revopaws_admin')
